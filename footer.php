    ...
    <div class="emdief-container">
        <div class="footer-grid">
            ...
            <div class="footer-col footer-contact-col">
                ...
                <!-- Sosyal Medya Kanalları (v1.8.5) -->
                <div class="footer-social-block">
                    <span class="social-title"><?php esc_html_e('Bizi Takip Edin:', 'mis360-mobilya'); ?></span>
                    <div class="footer-social-icons">
                        <a href="https://www.instagram.com/emdiefhome" target="_blank" rel="noopener noreferrer" class="social-btn btn-ig" title="Instagram @emdiefhome">
                            ...
                            <span>@emdiefhome</span>
                        </a>
                        <a href="https://www.youtube.com/@EmdiefHome" target="_blank" rel="noopener noreferrer" class="social-btn btn-yt" title="YouTube Montaj & Rehber">
                        ...
                        <a href="https://wa.me/<?php echo esc_attr(get_theme_mod('mis360_whatsapp', '905374778766')); ?>" target="_blank" rel="noopener noreferrer" class="social-btn btn-wa" title="WhatsApp Destek">
                            <?php echo function_exists('mis360_icon') ? mis360_icon('whatsapp', 18) : '💬'; ?>
                            <span>WhatsApp</span>
                        </a>
                    </div>
                </div>
