...
function mis360_add_installation_video_tab($tabs) {
    ...
    // 1. Teknik Özellikler & Ölçüler Sekmesi (v1.8.0)
    $tabs['product_specs_tab'] = [
        'title'    => esc_html__('Teknik Özellikler & Ölçüler', 'mis360-mobilya') . ' 📐',
        'priority' => 12,
        'callback' => 'mis360_render_product_specs_tab',
    ];

    // 2. Kurulum Videosu Sekmesi
    ...
    // 3. Sıkça Sorulan Sorular Sekmesi (v1.8.0)
    $tabs['product_faq_tab'] = [
        'title'    => esc_html__('Sıkça Sorulan Sorular', 'mis360-mobilya') . ' ❓',
        'priority' => 25,
